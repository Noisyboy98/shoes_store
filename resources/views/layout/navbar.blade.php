        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown04">
                        <a class="dropdown-item" href="{{ route('lang', ['lang' => 'vi']) }}"><img src="{{ asset('images/flags/vi.png')}}" title="{{__(trans('navbar.vi')) }}" alt="{{__(trans('navbar.vi')) }}"/></a>
                        <a class="dropdown-item" href="{{ route('lang', ['lang' => 'en']) }}"><img src="{{ asset('images/flags/en.png')}}" title="{{__(trans('navbar.en')) }}" alt="{{__(trans('navbar.en')) }}"/></a>
                    </div>
                </li>
